...
// This page is simply text that the user sees when they navigate to the About page
  ...
  <div className="about">
    <div>
      ...
      <h4>
        ...
        afternoon nap. And I definitely did not want to get anyone's allergies confused.
      </h4>
      <h4>
